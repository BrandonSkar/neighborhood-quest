/*! jsQR v1.4.0 — QR decoder used by the in-app "Scan sticker" camera.
 *  Apache-2.0. Source: https://github.com/cozmo/jsQR (npm jsqr@1.4.0, dist/jsQR.js).
 *  Vendored (minified by jsDelivr/Terser) so the app has no runtime CDN dependency
 *  and can still scan while offline. Exposes window.jsQR.
 */
